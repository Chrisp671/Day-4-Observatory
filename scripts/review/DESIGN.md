...
at 6,000,000 bytes before HTTP (the provider refused a 6,994,978-byte request; eight captures fit). These are local safety limits, not provider token guarantees.
